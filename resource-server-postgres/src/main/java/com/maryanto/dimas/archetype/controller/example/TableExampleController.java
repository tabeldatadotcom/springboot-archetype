...
import com.maryanto.dimas.archetype.mappers.example.TableExampleMapper;
...
public class TableExampleController {
    ...
    public ResponseEntity<?> createPost(@RequestBody @Valid TableExampleDto.New dto) {
        TableExample value = TableExampleMapper.ExampleNewMapper.converter.convertToEntity(dto);
    ...
    public ResponseEntity<?> updatePostById(@RequestBody @Valid TableExampleDto.Update dto) {
        log.info("{}", dto);
        TableExample value = TableExampleMapper.ExampleUpdateMapper.converter.convertToEntity(dto);
